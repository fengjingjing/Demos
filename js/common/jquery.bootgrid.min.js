...
!function(a, b, c) {
    ...
    if (I.defaults = {
        ...
        labels: {
            all: "All",
            infos: "显示 {{ctx.start}} 到  {{ctx.end}},共 {{ctx.total}} 条记录",
            loading: "Loading...",
            noResults: "没有查询到数据",
            refresh: "Refresh",
            search: "Search"
        ...
        templates: {
            ...
            search: '<div class="{{css.search}}"><div class="input-group"><span class="{{css.icon}} input-group-addon {{css.iconSearch}}"></span> <input type="text" class="{{css.searchField}}" placeholder="搜索" /></div></div>',/*placeholder="{{lbl.search}}*/
